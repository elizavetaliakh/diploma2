        ...
        success: function (data) {
            ...
            data.forEach(d => {
                switch(valuesListField) {
                    case 'to_mail_message_id': valuesList.push(d.toMailMessageId); break;
                    case 'custom': valuesList.push(d.custom); break;
                    case 'pto': valuesList.push(d.pto); break;
                    case 'lnp_photography': valuesList.push(d.lnpPhotography); break;
                    case 'lnp_inspection': valuesList.push(d.lnpInspection); break;
                    case 'lnp_custom': valuesList.push(d.lnpCustom); break;
                    case 'lnp_warehouse': valuesList.push(d.lnpWarehouse); break;
                    case 'good_description': valuesList.push(d.goodDescription); break;
                    case 'name_insp': valuesList.push(d.nameInsp); break;
                    case 'requirement': valuesList.push(d.requirement); break;
                    case 'sign_passport': valuesList.push(d.signPassport); break;
                    case 'sign_passport_detail': valuesList.push(d.signPassportDetail); break;
                    case 'sign_auto_release': valuesList.push(d.signAutoRelease); break;
                    case 'sign_risk': valuesList.push(d.signRisk); break;
                    case 'insp_cost': valuesList.push(d.inspCost); break;
                    case 'insp_currency_code': valuesList.push(d.inspCurrencyCode); break;
                    case 'insp_full_name': valuesList.push(d.inspFullName); break;
                    case 'status': valuesList.push(d.status); break;
                    case 'status_text': valuesList.push(d.statusText); break;
                    case 'sign_medical': valuesList.push(d.signMedical); break;
                    case 'sign_medical_comment': valuesList.push(d.signMedicalComment); break;
                    case 'release_weight': valuesList.push(d.releaseWeight); break;
                    case 'release_note': valuesList.push(d.releaseNote); break;
                    case 'refuse_cause': valuesList.push(d.refuseCause); break;
                    case 'refuse_note': valuesList.push(d.refuseNote); break;
                    case 'detencion_cause': valuesList.push(d.detencionCause); break;
                    case 'detencion_note': valuesList.push(d.detencionNote); break;
                    case 'detencion_code': valuesList.push(d.detencionCode); break;
                    case 'insp_corrected': valuesList.push(d.inspCorrected); break;
                    case 'to_send': valuesList.push(d.toSend); break;
                    case 'sign_risk_detail': valuesList.push(d.signRiskDetail); break;
                    case 'sign_req': valuesList.push(d.signReq); break;
                    case 'insp_weight_mail': valuesList.push(d.inspWeightMail); break;
                    case 'insp_total_cost_eur': valuesList.push(d.inspTotalCostEur); break;
                }
            })
        }
    });
            ...
            let table = document.querySelector('#clientsTable');
                for (let i = -1; i < data.length; i++) {
                    ...
                    for (let j = 0; j < 6; j++) {
                        ...
                        if (i == -1) {
                            switch(j) {
                                case 0: { td.innerHTML = 'ID клиента'; td.id = 'ThClientId'; break;}
                                case 1: { td.innerHTML = 'Полное имя'; td.id = 'ThFullName'; break;}
                                case 2: { td.innerHTML = 'Дата рождения'; td.id = 'ThDateBirth'; break;}
                                case 3: { td.innerHTML =  'Номер телефона'; td.id = 'ThPhoneNumber'; break;}
                                case 4: { td.innerHTML = 'Электронная почта'; td.id = 'ThEmail'; break;}
                                case 5: { td.innerHTML = 'Номер паспорта'; td.id = 'ThPassportNumber'; break;}
                            }
                        }
                        else {
                            switch(j) {
                                case 0: { td.innerHTML = data[i].clientId; break;}
                                case 1: { td.innerHTML = data[i].clientFullName; break;}
                                case 2: { td.innerHTML = data[i].birthDate; break;}
                                case 3: { td.innerHTML = data[i].clientPhoneNumber; break;}
                                case 4: { td.innerHTML = data[i].clientEmail; break;}
                                case 5: { td.innerHTML = data[i].passportNumber; break;}
                            }
                        }
                        tr.appendChild(td);
                    }
            ...
            let table = document.querySelector('#servicesTable');
                for (let i = -1; i < data.length; i++) {
                    ...
                    for (let j = 0; j < 5; j++) {
                        ...
                        if (i == -1) {
                            switch(j) {
                                case 0: { td.innerHTML = 'ID услуги'; td.id = 'ThServiceId'; break;}
                                case 1: { td.innerHTML = 'Название услуги'; td.id = 'ThServiceName'; break;}
                                case 2: { td.innerHTML = 'Цена'; td.id = 'ThServicePrice'; break;}
                                case 3: { td.innerHTML =  'Тип продуктов'; td.id = 'ThProductType'; break;}
                                case 4: { td.innerHTML = 'Описание'; td.id = 'ThServiceDescription'; break;}
                            }
                        }
                        else {
                            switch(j) {
                                case 0: { td.innerHTML = data[i].serviceId; break;}
                                case 1: { td.innerHTML = data[i].serviceName; break;}
                                case 2: { td.innerHTML = data[i].servicePrice; break;}
                                case 3: { td.innerHTML = data[i].productType; break;}
                                case 4: { td.innerHTML = data[i].serviceDescription; break;}
                            }
                        }
                        tr.appendChild(td);
                    }
            ...
            let table = document.querySelector('#onetimeServicesTable');
                for (let i = -1; i < data.length; i++) {
                    ...
                    for (let j = 0; j < 6; j++) {
                        ...
                        if (i == -1) {
                            switch(j) {
                                case 0: { td.innerHTML = 'ID сделки'; td.id = 'ThOnetimeServiceId'; break;}
                                case 1: { td.innerHTML = 'ID услуги'; td.id = 'ThOnetimeServiceServiceId'; break;}
                                case 2: { td.innerHTML = 'ID клиента'; td.id = 'ThOnetimeServiceClientId'; break;}
                                case 3: { td.innerHTML =  'Дата принятия'; td.id = 'ThAcceptionDate'; break;}
                                case 4: { td.innerHTML = 'Срок выполнения'; td.id = 'ThDeadlineDate'; break;}
                                case 5: { td.innerHTML = 'Ответственный сотрудник'; td.id = 'ThResponsibleEmployee'; break;}
                            }
                        }
                        else {
                            switch(j) {
                                case 0: { td.innerHTML = data[i].onetimeServiceId; break;}
                                case 1: { td.innerHTML = data[i].serviceId; break;}
                                case 2: { td.innerHTML = data[i].clientId; break;}
                                case 3: { td.innerHTML = data[i].acceptionDate; break;}
                                case 4: { td.innerHTML = data[i].deadlineDate; break;}
                                case 5: { td.innerHTML = data[i].responsibleEmployee; break;}
                            }
                        }
                        tr.appendChild(td);
                    }
            ...
            let table = document.querySelector('#operationTable');
                for (let i = -1; i < data.length; i++) {
                    ...
                    for (let j = 0; j < 41; j++) {
                        ...
                        if (i == -1) {
                            switch(j) {
                                case 0: { td.innerHTML = 'Operation ID'; td.id = 'ThOperationId'; break;}
                                case 1: { td.innerHTML = 'To mail message ID'; td.id = 'ThToMailMessageId'; break;}
                                case 2: { td.innerHTML = 'Custom'; td.id = 'ThCustom'; break;}
                                case 3: { td.innerHTML =  'Pto'; td.id = 'ThPto'; break;}
                                case 4: { td.innerHTML = 'Lnp photography'; td.id = 'ThLnpPhotography'; break;}
                                case 5: { td.innerHTML = 'Lnp inspection'; td.id = 'ThLnpInspection'; break;}
                                case 6: { td.innerHTML = 'Lnp custom'; td.id = 'ThLnpCustom'; break;}
                                case 7: { td.innerHTML = 'Lnp warehouse'; td.id = 'ThLnpWarehouse'; break;}
                                case 8: { td.innerHTML = 'Date photography'; td.id = 'ThDatePhotography'; break;}
                                case 9: { td.innerHTML = 'Date inspection'; td.id = 'ThDateInspection'; break;}
                                case 10: { td.innerHTML = 'Date custom'; td.id = 'ThDateCustom'; break;}
                                case 11: { td.innerHTML = 'Date warehouse'; td.id = 'ThDateWarehouse'; break;}
                                case 12: { td.innerHTML = 'Good description'; td.id = 'ThGoodDescription'; break;}
                                case 13: { td.innerHTML = 'Name inspection'; td.id = 'ThNameInsp'; break;}
                                case 14: { td.innerHTML = 'Requirement'; td.id = 'ThRequirement'; break;}
                                case 15: { td.innerHTML = 'Sign passport'; td.id = 'ThSignPassport'; break;}
                                case 16: { td.innerHTML = 'Sign passport detail'; td.id = 'ThSignPassportDetail'; break;}
                                case 17: { td.innerHTML = 'Date send'; td.id = 'ThDateSend'; break;}
                                case 18: { td.innerHTML = 'Sign auto release'; td.id = 'ThSignAutoRelease'; break;}
                                case 19: { td.innerHTML = 'Sign risk'; td.id = 'ThSignRisk'; break;}
                                case 20: { td.innerHTML = 'Inspection cost'; td.id = 'ThInspCost'; break;}
                                case 21: { td.innerHTML = 'Inspection currency code'; td.id = 'ThInspCurrencyCode'; break;}
                                case 22: { td.innerHTML = 'Inspection full name'; td.id = 'ThInspFullName'; break;}
                                case 23: { td.innerHTML = 'Status'; td.id = 'ThStatus'; break;}
                                case 24: { td.innerHTML = 'Status text'; td.id = 'ThStatusText'; break;}
                                case 25: { td.innerHTML = 'Sign medical'; td.id = 'ThSignMedical'; break;}
                                case 26: { td.innerHTML = 'Sign medical comment'; td.id = 'ThSignMedicalComment'; break;}
                                case 27: { td.innerHTML = 'Release weight'; td.id = 'ThReleaseWeight'; break;}
                                case 28: { td.innerHTML = 'Release note'; td.id = 'ThReleaseNote'; break;}
                                case 29: { td.innerHTML = 'Refuse cause'; td.id = 'ThRefuseCause'; break;}
                                case 30: { td.innerHTML = 'Refuse note'; td.id = 'ThRefuseNote'; break;}
                                case 31: { td.innerHTML = 'Detencion cause'; td.id = 'ThDetencionCause'; break;}
                                case 32: { td.innerHTML = 'Detencion note'; td.id = 'ThDetencionNote'; break;}
                                case 33: { td.innerHTML = 'Detencion code'; td.id = 'ThDetencionCode'; break;}
                                case 34: { td.innerHTML = 'Inspection corrected'; td.id = 'ThInspCorrected'; break;}
                                case 35: { td.innerHTML = 'To send'; td.id = 'ThToSend'; break;}
                                case 36: { td.innerHTML = 'Sign risk detail'; td.id = 'ThSignRiskDetail'; break;}
                                case 37: { td.innerHTML = 'Sign requirement'; td.id = 'ThSignReq'; break;}
                                case 38: { td.innerHTML = 'Inspection weight mail'; td.id = 'ThInspWeightMail'; break;}
                                case 39: { td.innerHTML = 'Inspection total cost (eur)'; td.id = 'ThInspTotalCostEur'; break;}
                            }
                        }
                        else {
                            switch(j) {
                                case 0: { td.innerHTML = data[i].operationId; break;}
                                case 1: { td.innerHTML = data[i].toMailMessageId; break;}
                                case 2: { td.innerHTML = data[i].custom; break;}
                                case 3: { td.innerHTML = data[i].pto; break;}
                                case 4: { td.innerHTML = data[i].lnpPhotography; break;}
                                case 5: { td.innerHTML = data[i].lnpInspection; break;}
                                case 6: { td.innerHTML = data[i].lnpCustom; break;}
                                case 7: { td.innerHTML = data[i].lnpWarehouse; break;}
                                case 8: { td.innerHTML = data[i].datePhotography; break;}
                                case 9: { td.innerHTML = data[i].dateInspection; break;}
                                case 10: { td.innerHTML = data[i].dateCustom; break;}
                                case 11: { td.innerHTML = data[i].dateWarehouse; break;}
                                case 12: { td.innerHTML = data[i].goodDescription; break;}
                                case 13: { td.innerHTML = data[i].nameInsp; break;}
                                case 14: { td.innerHTML = data[i].requirement; break;}
                                case 15: { td.innerHTML = data[i].signPassport; break;}
                                case 16: { td.innerHTML = data[i].signPassportDetail; break;}
                                case 17: { td.innerHTML = data[i].dateSend; break;}
                                case 18: { td.innerHTML = data[i].signAutoRelease; break;}
                                case 19: { td.innerHTML = data[i].signRisk; break;}
                                case 20: { td.innerHTML = data[i].inspCost; break;}
                                case 21: { td.innerHTML = data[i].inspCurrencyCode; break;}
                                case 22: { td.innerHTML = data[i].inspFullName; break;}
                                case 23: { td.innerHTML = data[i].status; break;}
                                case 24: { td.innerHTML = data[i].statusText; break;}
                                case 25: { td.innerHTML = data[i].signMedical; break;}
                                case 26: { td.innerHTML = data[i].signMedicalComment; break;}
                                case 27: { td.innerHTML = data[i].releaseWeight; break;}
                                case 28: { td.innerHTML = data[i].releaseNote; break;}
                                case 29: { td.innerHTML = data[i].refuseCause; break;}
                                case 30: { td.innerHTML = data[i].refuseNote; break;}
                                case 31: { td.innerHTML = data[i].detencionCause; break;}
                                case 32: { td.innerHTML = data[i].detencionNote; break;}
                                case 33: { td.innerHTML = data[i].detencionCode; break;}
                                case 34: { td.innerHTML = data[i].inspCorrected; break;}
                                case 35: { td.innerHTML = data[i].toSend; break;}
                                case 36: { td.innerHTML = data[i].signRiskDetail; break;}
                                case 37: { td.innerHTML = data[i].signReq; break;}
                                case 38: { td.innerHTML = data[i].inspWeightMail; break;}
                                case 39: { td.innerHTML = data[i].inspTotalCostEur; break;}
                            }
                        }
                        tr.appendChild(td);
                    }
